...
- 个股分析：`stock-analysis.md`、`valuation.md`、`risk-avoidance.md`、`position-sizing.md`；涉及管理层时加载 `management-analysis.md`，涉及年报、半年报或研报时加载 `financial-statement-research.md`
- 行业/板块分析：`top-down-policy.md`、`business-model.md`、`risk-avoidance.md`；涉及宏观数据、利率或衰退情景时加载 `macro-monitoring.md`
...
- 组合复盘、再平衡或永久组合：`portfolio-construction.md`、`position-sizing.md`、`secondary-verification.md`
...
- 年报、半年报、景气度和研报阅读：`financial-statement-research.md`
- 管理层、实控人、CEO/CFO、关联交易或激励：`management-analysis.md`
- 宏观数据、流动性、利率、收益率曲线或衰退情景：`macro-monitoring.md`
